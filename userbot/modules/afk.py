...
# ========================= CONSTANTS ============================
AFKSTR = [
    "`My master is busy right now. Please talk in a bag and when he will come back you can just give him the bag!`",
    ...
    "`Life is so short, there are so many things to do...\nmy master is away doing one of them..`",
